...
app.include_router(solve_legacy.router, prefix="/solve-legacy", tags=["Legacy Logic"])
app.include_router(quantum.router, prefix="/quantum", tags=["Quantum Mode"])
app.include_router(scroll.router, prefix="/scroll", tags=["Codex Reasoning"])
app.include_router(schema.router, prefix="/schema", tags=["Schema Explorer"])